...
- [x] Standardized evergreen tax season deadlines (**April 30** / **June 15**).
- [x] Added PDF Tax Checklist CTA download feature.
- [x] Built interactive FAQ accordion section (5 bilingual questions & answers).
- [x] Built 4-step "How It Works" (*Notre processus*) section.
- [x] Updated Laval office address (`2 Place Laval, bureau 485`), phone `(438) 994-9140`, and email `client@countup.ca`.
- [x] Embedded interactive Google Maps iframe.
